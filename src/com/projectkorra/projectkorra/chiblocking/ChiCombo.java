...
public class ChiCombo {
     ...
     * expired, it removes them from
     * {@link ChiCombo#paralyzedEntities paralyzedEntities} and removes the
     * instance of the combo from {@link ChiCombo#instances instances}.
     */
